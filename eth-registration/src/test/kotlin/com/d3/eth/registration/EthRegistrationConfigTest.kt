...
class EthRegistrationConfigTest {
    ...
    fun allEnvironmentVariablesEthPasswordTest() {
        ...
        environmentVariables.set("ETH-REGISTRATION_REGISTRATIONCREDENTIAL_PUBKEY", registrationCredentialPubkey)
        val registrationCredentialPrivkey = "privkey..."
        environmentVariables.set("ETH-REGISTRATION_REGISTRATIONCREDENTIAL_PRIVKEY", registrationCredentialPrivkey)
